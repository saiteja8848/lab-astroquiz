...
public class Eligibility extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean spaceEligible = eligibiltyCheck.checkQuizAnswer(points);

		if (spaceEligible) {
			RequestDispatcher rd = this.getServletContext().getRequestDispatcher("/WEB-INF/views/success.jsp");
